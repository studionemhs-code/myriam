    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-border bg-muted/20 p-4">
        ...
        <div className="mb-4 grid gap-3 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2"><AgentVoicePreview key={`${agent?.id || 'new'}-${form.default_voice}-${form.voice_language}-${agent?.updated_date || ''}`} voice={form.default_voice} language={form.voice_language} apiKey={form.openai_api_key} /></div>
        </div>
